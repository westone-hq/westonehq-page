...
상품 구성(정가 → 초기 도입가 / 납기):
- 리포트원 라이트 (설문·성과분석 자동화 프로그램 구축): 350만원 → 280만원 / 2주
- 리포트원 스탠다드 (반복업무 자동화 프로그램 구축, 기본형): 500만원 → 420만원 / 3주
- 리포트원 풀세트 (접수 시스템 및 자동화 프로그램 통합 구축): 850만원 → 690만원 / 6주
- AI 드래프트 (옵션, AI 기반 분석 코멘트 초안 생성 모듈): +250만원 → +200만원 / +1~2주
- 케어원 (구독, 유지보수 및 운영 지원): 월 12만원 → 월 10만원 (연 계약)
...
상품 구성(정가 → 초기 도입가 / 납기):
- 서비스원 베이직 (반응형 브랜드 홈페이지 구축, 5페이지): 280만원 → 220만원 / 2주
- 서비스원 스토어 (온라인 쇼핑몰 구축): 550만원 → 450만원 / 4주
- 서비스원 프로 (맞춤형 웹 서비스 구축, 예약·접수·회원): 800만원~ → 650만원~ / 6주~
- 운영 자동화 연동 (옵션, 주문·정산 보고서 자동화, 리포트원 연동): +300만원~ → +250만원~ / +2주
- 케어원 (구독, 유지보수·호스팅 관리): 월 15만원 → 월 12만원 (연 계약)
※ 초기 도입가 조건·부가세 별도 동일.
...
웹 옵션 가격: 페이지 추가 +25만 / 상품 10개 추가 등록 +15만 / 상세페이지 디자인 1종 +40만 / 예약·문의 접수 기능 +80만 / 영문 버전 +150만 / 스마트스토어 동시 입점 +60만.
...
- 쇼핑몰 비용·기간은? → 서비스원 스토어 기준 초기 도입가 450만원·4주(정가 550만원). 결제 연동·기본 관리자 기능 포함.
